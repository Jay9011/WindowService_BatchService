...
/// <summary>
/// Schedule kind for a batch entry. Values match the TINYINT stored in <c>BatchList.ScheduleType</c> 
/// and the <c>CK_BatchList_ScheduleShape</c> constraint in the database.
/// </summary>
